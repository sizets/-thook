      ...
      <div className="flex flex-col justify-center gap-10 my-10 md:flex-row mb-28">
        ...
        <div className="flex flex-col items-start justify-center gap-6">
          ...
          <p className="text-gray-500">
            Thook 354 Tech Lane <br />
            Los Angeles, SC 45678, USA
          </p>
          <p className="text-gray-500">
            Tel: (+11)-558-669-447 <br />
            Email: contact.Thook@info.com
          </p>
          <p className="text-xl font-semibold text-gray-600">
            Careers at Thook
          </p>
          <p className="text-gray-500">
            Join us at Thook! Explore job openings and help shape the future of
            tablet technology. <br />
            Explore our current job openings and discover how you can contribute
            to our mission of innovation and digital excellence.
          </p>
