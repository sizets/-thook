    ...
    <div className="flex flex-col justify-around gap-12 py-8 text-xs text-center text-gray-700 sm:flex-row sm:gap-2 sm:text-sm md:text-base">
      ...
      <div>
        <img
          ...
          alt="Quality"
        />
        <p className="mb-2 font-semibold">Premium Tablet Quality</p>
        <p className="text-gray-400">Thook ensures top-quality tablets.</p>
      </div>
      <div>
        <img
          ...
          alt="Support"
        />
        <p className="mb-2 font-semibold">Expert Tech Support</p>
